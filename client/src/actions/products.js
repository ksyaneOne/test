...
export const FETCH_PRODUCTS_BY_FILTER_QUERY_START =
  "FETCH_PRODUCTS_BY_FILTER_QUERY_START";
export const FETCH_PRODUCTS_BY_FILTER_QUERY_SUCCESS =
  "FETCH_PRODUCTS_BY_FILTER_QUERY_SUCCESS";
export const FETCH_PRODUCTS_BY_FILTER_QUERY_FAILURE =
  "FETCH_PRODUCTS_BY_FILTER_QUERY_FAILURE";

// Fetch  PRODUCTS By Search Phrases
export const FETCH_PRODUCTS_BY_SEARCH_PHRASE_START =
  "FETCH_PRODUCTS_BY_SEARCH_PHRASE_START";
export const FETCH_PRODUCTS_BY_SEARCH_PHRASE_SUCCESS =
  "FETCH_PRODUCTS_BY_SEARCH_PHRASE_SUCCESS";
export const FETCH_PRODUCTS_BY_SEARCH_PHRASE_FAILURE =
